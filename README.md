...
3. 表示された Package ID を `src/constants.ts` に反映：
   ```typescript
   export const PACKAGE_ID = '0xメインネットのPackageID'
...
|------|------|
| ネットワーク | Sui Testnet |
| Package ID | `0xd21845143eb18c5a9135482f01f21470d266fcb58ac0305a95875f1d4cca25fa` |
| モジュール | `studio` |
| NFT 構造体 | `Orbit` |
| ミント関数 | `studio::mint(name, description, url, recipient)` |

### コントラクトの確認

- [Sui Testnet Explorer](https://suiexplorer.com/object/0xd21845143eb18c5a9135482f01f21470d266fcb58ac0305a95875f1d4cca25fa?network=testnet) でコントラクトの詳細を確認できます。
